...
<?php if(get_the_category()[0]->name == "portifolio_servicos"): ?>
    ...
    <div class="card card-" style="width: 18rem;">
        <?php echo get_the_post_thumbnail($post->id, 'large', ['class' => 'img-fluid single-image', 'alt' => 'single image']); ?>
        <div class="card-body">
            <h5 class="card-title text-center"><?php echo $post->post_title ?></h5>
